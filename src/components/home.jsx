  ...
  return (
    <div  className='main-box'>
        <div className='header-home' >
           ...
           <div className='head-motive' > <div className='motive-animation'> motive </div>   </div> 
           <div>  <Link  className='taggs' to="/login">account</Link></div>       
          </div>

    <div >
<div >
 <div className='newbiee' >
   <div className='newbie' onClick={()=>Details(0)}> {info.country}</div><div className='newbie'  onClick={()=>Details(1)}>{info.state}</div><div className='newbie'  onClick={()=>Details(2)}>{info.district}</div>
   <div className='newbie' onClick={()=>Details(3)}>{info.mandal}</div><div className='newbie' onClick={()=>Details(4)}>{info.village}</div><div className='newbie' onClick={()=>Details(5)}>{info.sub_village}</div>
